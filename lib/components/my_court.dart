...
class _MyCourtState extends State<MyCourt> {
  bool _isFavorite = true; // <-- state thực sự, chỉ khai báo 1 lần ở đây

  void _toggleFavorite() {
    setState(() {
      _isFavorite = !_isFavorite; // <-- đổi trực tiếp biến state
    });
  }
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                          image: AssetImage("assets/images/badminton_logo.jpg"),
                          fit: BoxFit.contain,
                        ),
                      ),
                    ),
